...
let ShopSidebarComponent = class ShopSidebarComponent {
    constructor(sidebar, platformId) {
        this.sidebar = sidebar;
    ...
    ngOnInit() {
        this.sidebar.isOpen$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.destroy$)).subscribe(isOpen => {
            if (isOpen) {
                this.open();
            }
            else {
        ...
        if (Object(_angular_common__WEBPACK_IMPORTED_MODULE_7__["isPlatformBrowser"])(this.platformId)) {
            Object(_shared_functions_rxjs_fromMatchMedia__WEBPACK_IMPORTED_MODULE_6__["fromMatchMedia"])('(max-width: 991px)').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.destroy$)).subscribe(media => {
    ...
    ngOnInit() {
        this.compare.items$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.destroy$)).subscribe(products => {
            ...
            products.forEach(product => product.features.forEach(productFeature => {
                let feature = features.find(eachFeature => eachFeature.name === productFeature.name);
                if (!feature) {
                    feature = {
...
let PageProductComponent = class PageProductComponent {
    constructor(route) {
        ...
        this.route.params.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(params => {
            if (params.hasOwnProperty('id')) {
                const product = _data_shop_products__WEBPACK_IMPORTED_MODULE_2__["products"].find(eachProduct => eachProduct.id === parseFloat(params.id));
                if (product) {
                    return product;
                }
            }
